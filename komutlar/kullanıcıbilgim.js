...
exports.run = (client, message, params) => {
    if (message.channel.type !== "group") {
        ...
        var Durm = (Durum == "online" ? (0x00AE86) : (Durum == "online" ? (0x808080) : (Durum == "idle" ? (0xFFFF00) : (Durum == "dnd" ? (0xFF0000) : (0x00AE86)))))
        var durm = (Durum == "online" ? ("�evrimi�i") : (Durum == "online" ? ("�evrimd���") : (Durum == "idle" ? ("Bo�ta") : (Durum == "dnd" ? ("Rahats�z Etmeyin") : ("Bilinmiyor/bulunamad�.")))))
