...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "sa") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.reply(
        "** Aleyküm Selam,  Hoş Geldin!** <a:kalp:795292476167815188> "
      );
    } else {
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "selam") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      ...
      msg.reply("Aleyküm selam, hoş geldin <a:kalp:795292476167815188>");
    }
  }
});
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "iyi geceler") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.reply("**İyi Geceler, Görüşürüz** <a:kalp:795292476167815188> ");
    } else {
      msg.reply("İyi Geceler, Görüşürüz <a:kalp:795292476167815188>");
    }
  }
...
client.on("message", msg => {
  if (msg.content.toLowerCase() === "nasılsın") {
    if (!msg.guild.member(msg.author).hasPermission("BAN_MEMBERS")) {
      msg.reply("**Biz İyiyiz Seni Sormalı** <a:kalp:795292476167815188> ");
    } else {
      msg.reply("Biz İyiyiz Seni Sormalı <a:kalp:795292476167815188> ");
    }
  }
